...
Nesta etapa, escolhemos algoritmos de processamento de imagens existentes na VisionGL para adaptação dos conceitos originais para as ferramentas que buscamos analizar.
...
Além disso, é necessário analisar a transferência de dados entre a memória do dispositivo e a memória do hospedeiro (\textit{upload}/\textit{download}), bem como o gerenciamento de memória para garantir que os dados sejam acessados de forma eficiente durante a execução dos \textit{kernels}.
