...
Dois padrões recorrentes são o \emph{data parallelism} uma única tarefa é aplicada para todas as \textit{threads}, e o \emph{task parallelism} as \textit{threads} são distribuidas para múltiplas tarefas~\cite{james23dpcpp}. Esses modelos orientam a escolha de algoritmos e frameworks de programação paralela.
Será dado ênfase no \emph{data parallelism}, pois é o modelo mais adequado para o processamento de imagens, que é o foco deste trabalho.
