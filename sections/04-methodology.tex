...
Foi criado um \textit{fork} da biblioteca VisionGL\footnote{\url{https://github.com/ddantas/visiongl}} para estudo da estrutura do projeto e desenvolvimento dos operadores lógicos em outras tecnologias. O \textit{fork} está num repositório do GitHub\footnote{\url{https://github.com/jusqua/visiongl}}.
...
A imagem de teste utilizada nos experimentos é a mostrada na \Cref{fig:fundus} com dimensões de 3504 $\times$ 2336 pixels e 3 canais de cor. A imagem foi escolhida por ser grande o suficiente para ter um atraso significativo no processamento.
