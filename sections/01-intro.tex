...
O \textit{framework} proprietário CUDA~\cite{nickolls2008} promove uma API (do inglês \textit{Application Programming Interface}) para desenvolvimento de programas com processamento paralelo em dispositivos de GPU específicos da fabricante NVIDIA. Utilizaremos a linguagem de programação Julia como o pacote CUDA.jl~\cite{besard2018juliagpu} para produzir algoritmos de processamento de imagens.
