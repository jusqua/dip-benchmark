...
O aumento da demanda por desempenho computacional, especialmente em áreas que requerem processamento de grande volume de dados em diversas estruturas, levou ao crescente uso de arquiteturas heterogêneas como \textit{Central Processing Unit} (CPUs), \textit{Graphics Processing Unit} (GPUs) e aceleradores diversos. A diversidade de arquiteturas contém desafios para portabilidade de ferramentas computacionais~\cite{pacheco11}.
